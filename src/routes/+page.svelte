<script lang="ts">
  ...
  import { viamClient } from '../lib/index.js';
  ...
  function exportConfig() {
    ...
    a.href = url;
    a.download = `${config.name || 'event'}-config.json`;
    a.click();
...
<div class="container">
  <h1>Viam Event Manager Configuration</h1>
  ...
  <div class="form-section">
    <button class="btn btn-success" on:click={exportConfig}>Export Configuration</button>
  </div>
</div>
